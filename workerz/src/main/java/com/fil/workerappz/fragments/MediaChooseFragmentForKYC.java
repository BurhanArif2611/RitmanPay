...
public class MediaChooseFragmentForKYC extends BottomSheetDialogFragment {
    ...
    private UploadYourDocumentActivity uploadYourDocumentActivity;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        try {
            SessionManager sessionManager = new SessionManager(uploadYourDocumentActivity);
    ...
    public void onResume() {
        ...
        if (cameraPermission) {
            ...
            uploadYourDocumentActivity.startCameraActivity();
        ...
        if (readPermission) {
            ...
            uploadYourDocumentActivity.openGallery();
    ...
    public void onAttach(Context context) {
        ...
        uploadYourDocumentActivity = (UploadYourDocumentActivity) context;
    }
